...
import page.EventoPage;
import service.EventoService;
import utils.GeneratorData;
import org.junit.*;
...
public class EventoTest {
    ...
    public void cenario2_criarEventoComDataMenorQueAtual() throws Exception {
        evento.preencherNomeEvento("Evento " + GeneratorData.firstName);
        evento.preencherDescricaoEvento( "Descricao evento para " + GeneratorData.firstName);
        evento.preencherDataEvento( GeneratorData.datesPast);
    ...
    public void cenario3_criarEventoComSucesso() throws Exception {
        evento.preencherNomeEvento("Evento " + GeneratorData.firstName);
        evento.preencherDescricaoEvento( "Descricao evento para " + GeneratorData.firstName);
        evento.preencherDataEvento( GeneratorData.dates);
        evento.clicarCriarEvento();
